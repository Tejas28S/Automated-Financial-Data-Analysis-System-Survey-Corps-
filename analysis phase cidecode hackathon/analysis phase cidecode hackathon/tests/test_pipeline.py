...
def main():
    ...
    if dup01.exists():
        ...
        p1_key = "1_duplicate_detection_cross_check"
    ...
    print("\n" + "="*80)
    print("  TEST: Money Trail Case 01 (Pattern 10)")
    print("="*80)
    ...
    if mt01.exists():
        ...
        p10_key = "10_money_trail_tracing"

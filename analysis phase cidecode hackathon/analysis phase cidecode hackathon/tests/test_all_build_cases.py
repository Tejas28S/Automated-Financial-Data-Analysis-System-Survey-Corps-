...
PROJECT_DIR = Path(r"c:\Users\msant\OneDrive\Desktop\analysis phase cidecode hackathon\analysis phase cidecode hackathon")
...
SYNTHETIC = PROJECT_DIR / "synthetic_data"
PASS = "[PASS]"
FAIL = "[FAIL]"
results = []
...
p4 = r.findings_by_pattern.get("4_round_trip_detection", [])
...
p9 = r.findings_by_pattern.get("9_circular_flow_multi_hop_cycle_detection", [])
...
p4b = r2.findings_by_pattern.get("4_round_trip_detection", [])
...
p5 = r.findings_by_pattern.get("5_transit_pass_through_detection", [])
...
p5b = r2.findings_by_pattern.get("5_transit_pass_through_detection", [])
...
p6 = r.findings_by_pattern.get("6_accumulation_account_detection", [])
...
p6b = r2.findings_by_pattern.get("6_accumulation_account_detection", [])
...
p7 = r.findings_by_pattern.get("7_structuring_smurfing_detection", [])
...
p7b = r2.findings_by_pattern.get("7_structuring_smurfing_detection", [])
...
p1 = r.findings_by_pattern.get("1_duplicate_detection_cross_check", [])
...
p1b = r2.findings_by_pattern.get("1_duplicate_detection_cross_check", [])
...
p9b = r2.findings_by_pattern.get("9_circular_flow_multi_hop_cycle_detection", [])
...
p10 = r.findings_by_pattern.get("10_money_trail_tracing", [])
...
p10b = r2.findings_by_pattern.get("10_money_trail_tracing", [])
